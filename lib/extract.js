...
var _waitForStuff = require('wait-for-stuff');

var _waitForStuff2 = _interopRequireDefault(_waitForStuff);
...
var _extractorFactory = function _extractorFactory(configuration) {
  ...
  var parseVueFile = function parseVueFile(filename) {
    ...
    function serilizeNode(content) {
      ...
      var html = '';
      var waiter = new _events2.default();
      ...
      _waitForStuff2.default.for.event(waiter, 'continue');
